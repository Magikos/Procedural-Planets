...
Our filenames drop the source prefix. `SM_Chr_Priest_01` is the sub-mesh we look up inside
the pack; `Priest_01` is what we call the result. `HumanOutfitConverter.RoleName` is
