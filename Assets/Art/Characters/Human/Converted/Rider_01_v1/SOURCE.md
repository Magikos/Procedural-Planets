# Rider outfit conversion, revision v1
...
Our filenames drop the source prefix. `SM_Chr_Rider_01` is the sub-mesh we look up inside
the pack; `Rider_01` is what we call the result. `HumanOutfitConverter.RoleName` is
