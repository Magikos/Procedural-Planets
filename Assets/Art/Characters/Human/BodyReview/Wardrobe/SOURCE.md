...
- `SM_Chr_Rider_01`: fitted riding clothes, boots, and hand covering.
- `SM_Chr_Soldier_Male_01`: armor and limb protection.
- `SM_Chr_Blacksmith_Female_01`: female-authored clothing and apron.
- `SM_Chr_Mage_01`: short tunic with an integrated hood; saved separately.
- `SM_Chr_Priest_01`: long robe, used in the scene's fourth pair.
