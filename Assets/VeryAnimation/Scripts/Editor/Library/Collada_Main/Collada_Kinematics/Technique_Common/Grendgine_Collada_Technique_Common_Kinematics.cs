...
namespace VeryAnimation.grendgine_collada
{
    ...
    public partial class Grendgine_Collada_Technique_Common_Kinematics : Grendgine_Collada_Technique_Common
    {
        ...
        public Grendgine_Collada_Axis_Info_Kinematics[] Axis_Info { get; set; }

        [XmlElement(ElementName = "frame_origin")]
        public Grendgine_Collada_Frame_Origin Frame_Origin { get; set; }

        [XmlElement(ElementName = "frame_tip")]
        public Grendgine_Collada_Frame_Tip Frame_Tip { get; set; }

        [XmlElement(ElementName = "frame_tcp")]
        public Grendgine_Collada_Frame_TCP Frame_TCP { get; set; }

        [XmlElement(ElementName = "frame_object")]
        public Grendgine_Collada_Frame_Object Frame_Object { get; set; }
