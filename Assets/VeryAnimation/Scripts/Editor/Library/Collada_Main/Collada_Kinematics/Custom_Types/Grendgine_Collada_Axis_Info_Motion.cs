...
namespace VeryAnimation.grendgine_collada
{
    ...
    public partial class Grendgine_Collada_Axis_Info_Motion : Grendgine_Collada_Axis_Info
    {
        ...
        public Grendgine_Collada_New_Param[] Set_Param { get; set; }

        [XmlElement(ElementName = "speed")]
        public Grendgine_Collada_Common_Float_Or_Param_Type Speed { get; set; }

        [XmlElement(ElementName = "acceleration")]
        public Grendgine_Collada_Common_Float_Or_Param_Type Acceleration { get; set; }

        [XmlElement(ElementName = "deceleration")]
        public Grendgine_Collada_Common_Float_Or_Param_Type Deceleration { get; set; }

        [XmlElement(ElementName = "jerk")]
        public Grendgine_Collada_Common_Float_Or_Param_Type Jerk { get; set; }
