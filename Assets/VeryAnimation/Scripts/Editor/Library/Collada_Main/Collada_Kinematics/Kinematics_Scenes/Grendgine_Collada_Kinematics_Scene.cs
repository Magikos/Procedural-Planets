...
namespace VeryAnimation.grendgine_collada
{
    ...
    public partial class Grendgine_Collada_Kinematics_Scene
    {
        ...
        public Grendgine_Collada_Instance_Kinematics_Model[] Instance_Kinematics_Model { get; set; }

        [XmlElement(ElementName = "instance_articulated_system")]
        public Grendgine_Collada_Instance_Articulated_System[] Instance_Articulated_System { get; set; }
