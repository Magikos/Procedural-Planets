...
namespace VeryAnimation.grendgine_collada
{
    ...
    public partial class Grendgine_Collada_Instance_Physics_Model
    {
        ...
        public Grendgine_Collada_Instance_Rigid_Body[] Instance_Rigid_Body { get; set; }

        [XmlElement(ElementName = "instance_rigid_constraint")]
        public Grendgine_Collada_Instance_Rigid_Constraint[] Instance_Rigid_Constraint { get; set; }
