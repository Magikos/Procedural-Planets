...
namespace VeryAnimation.grendgine_collada
{
    ...
    public partial class Grendgine_Collada_Constraint_Spring_Type
    {
        ...
        public Grendgine_Collada_SID_Float Stiffness { get; set; }

        [XmlElement(ElementName = "damping")]
        public Grendgine_Collada_SID_Float Damping { get; set; }

        [XmlElement(ElementName = "target_value")]
        public Grendgine_Collada_SID_Float Target_Value { get; set; }
    }
}
