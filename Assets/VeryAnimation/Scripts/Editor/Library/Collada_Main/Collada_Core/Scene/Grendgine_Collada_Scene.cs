...
namespace VeryAnimation.grendgine_collada
{
    ...
    public partial class Grendgine_Collada_Scene
    {
        ...
        public Grendgine_Collada_Instance_Visual_Scene Visual_Scene { get; set; }

        [XmlElement(ElementName = "instance_physics_scene")]
        public Grendgine_Collada_Instance_Physics_Scene[] Physics_Scene { get; set; }

        [XmlElement(ElementName = "instance_kinematics_scene")]
        public Grendgine_Collada_Instance_Kinematics_Scene Kinematics_Scene { get; set; }
