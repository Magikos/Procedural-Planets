...
namespace VeryAnimation.grendgine_collada
{
    ...
    public partial class Grendgine_Collada_Effect_Technique_Evaluate
    {
        ...
        public Grendgine_Collada_Color_Target Color_Target { get; set; }

        [XmlElement(ElementName = "depth_target")]
        public Grendgine_Collada_Depth_Target Depth_Target { get; set; }

        [XmlElement(ElementName = "stencil_target")]
        public Grendgine_Collada_Stencil_Target Stencil_Target { get; set; }

        [XmlElement(ElementName = "color_clear")]
        public Grendgine_Collada_Color_Clear Color_Clear { get; set; }

        [XmlElement(ElementName = "depth_clear")]
        public Grendgine_Collada_Depth_Clear Depth_Clear { get; set; }

        [XmlElement(ElementName = "stencil_clear")]
        public Grendgine_Collada_Stencil_Clear Stencil_Clear { get; set; }

        [XmlElement(ElementName = "draw")]
        public Grendgine_Collada_Draw Draw { get; set; }
