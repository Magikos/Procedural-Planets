...
namespace VeryAnimation.grendgine_collada
{
    ...
    public partial class Grendgine_Collada_Create_2D
    {
        ...
        public Grendgine_Collada_Size_2D Size_Exact { get; set; }


        [XmlElement(ElementName = "size_ratio")]
        public Grendgine_Collada_Size_Ratio Size_Ratio { get; set; }

        [XmlElement(ElementName = "mips")]
        public Grendgine_Collada_Mips_Attribute Mips { get; set; }



        [XmlElement(ElementName = "unnormalized")]
        public XmlElement Unnormalized { get; set; }

        [XmlElement(ElementName = "array")]
        public Grendgine_Collada_Array_Length Array_Length { get; set; }


        [XmlElement(ElementName = "format")]
        public Grendgine_Collada_Format Format { get; set; }

        [XmlElement(ElementName = "init_from")]
        public Grendgine_Collada_Init_From[] Init_From { get; set; }
