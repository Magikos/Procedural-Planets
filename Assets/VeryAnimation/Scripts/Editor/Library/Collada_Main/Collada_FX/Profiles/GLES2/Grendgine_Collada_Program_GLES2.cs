...
namespace VeryAnimation.grendgine_collada
{
    ...
    public partial class Grendgine_Collada_Program_GLES2
    {
        ...
        public Grendgine_Collada_Linker[] Linker { get; set; }

        [XmlElement(ElementName = "shader")]
        public Grendgine_Collada_Shader_GLES2[] Shader { get; set; }

        [XmlElement(ElementName = "bind_attribute")]
        public Grendgine_Collada_Bind_Attribute[] Bind_Attribute { get; set; }

        [XmlElement(ElementName = "bind_uniform")]
        public Grendgine_Collada_Bind_Uniform[] Bind_Uniform { get; set; }
    }
}
