...
| Touching caustics | **Allowed, verify carefully** | The don't-touch rule was lifted 2026-08-11. Relevant here because `CloudShadows.hlsl` feeds `Ocean.shader` — see the include warning above. Verify caustics, shoreline and depth blend before committing. |
