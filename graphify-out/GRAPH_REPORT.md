...
1. `Planet` - 57 edges
2. `WeatherManager` - 57 edges
3. `DebugCaptureController` - 51 edges
4. `FreeCameraController` - 49 edges
5. `ChunkedSurfaceProvider` - 39 edges
6. `ConsoleInputController` - 38 edges
7. `PrecipitationController` - 38 edges
8. `ScaleReferenceMarkers` - 37 edges
9. `CelestialManager` - 37 edges
10. `ChunkVisibilitySelector` - 37 edges

## Surprising Connections (you probably didn't know these)
- `CloudController` --implements--> `ICloudRuntime`  [EXTRACTED]
  Planet/Clouds/CloudController.cs → Core/Services/ServiceLocator.cs
- `AtmosphereController` --implements--> `IAtmosphereRuntime`  [EXTRACTED]
  Planet/Atmosphere/AtmosphereController.cs → Core/Services/ServiceLocator.cs
- `Planet` --implements--> `IEarlyInitialize`  [EXTRACTED]
  Planet/Planet.cs → Core/Interfaces/IEarlyInitialize.cs
- `Planet` --implements--> `ILateInitialize`  [EXTRACTED]
  Planet/Planet.cs → Core/Interfaces/ILateInitialize.cs
- `WeatherManager` --implements--> `ILateInitialize`  [EXTRACTED]
  Planet/WeatherManager.cs → Core/Interfaces/ILateInitialize.cs
...
Cohesion: 0.15
Nodes (10): ClimateCommands, TemperatureUnitPreferences, ClimateLatitudePreset, Awaitable, BiomeDto, CancellationToken, ConsoleCommand, Planet (+2 more)

### Community 26 - "Community 26"
Cohesion: 0.08
Nodes (19): Attribute, Binding, string, Type, MonoTargetType, string, string, Dictionary (+11 more)

### Community 27 - "Community 27"
Cohesion: 0.12
Nodes (18): GrassAtlasPixels, Action, Action<float>, Awaitable, CancellationToken, Color32, CubeEdge, float (+10 more)

### Community 28 - "Community 28"
Cohesion: 0.11
Nodes (17): IBiomeProvider, ColorGenerator, Action<float>, Awaitable, BiomeDto, BiomeRegistryDto, BiomeResult, BiomeSurfaceTextureArrays (+9 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (23): IFaceMeshSampler, float, int, PlanetChunk, Vector3, Color, float, float3 (+15 more)
...
Cohesion: 0.11
Nodes (15): Array, ChunkLifecycle, Bounds, byte, Color, Color32, float, int (+7 more)
...
Cohesion: 0.11
Nodes (17): CloudController, CloudRenderPass, CloudRenderFeature, CloudRenderPass, PassData, Camera, ContextContainer, float (+9 more)
...
Cohesion: 0.12
Nodes (14): GrassNearFieldController, GrassPlacementController, IGrassNearFieldStatsProvider, bool, float, GrassNearFieldStats, GrassRenderLayer, GrassRuntimeState (+6 more)
...
Cohesion: 0.24
Nodes (8): BiomeMapBaker, BiomeLookupData, Color, Color32, int, PlanetChunk, Vector2, VoronoiBiomeField
...
Cohesion: 0.14
Nodes (10): GrassChunkRuntime, bool, Bounds, Camera, GraphicsBuffer, GrassBladeBufferPool, int, Material (+2 more)
...
Cohesion: 0.18
Nodes (7): ConsoleCommandAttribute, CommandData, Dictionary, MethodInfo, T, Type, ConsoleRegistry
...
Cohesion: 0.14
Nodes (10): AtmosphereRenderFeature, AtmosphereController, AtmosphereRenderPass, Camera, float, int, Material, Plane (+2 more)
...
Cohesion: 0.31
Nodes (12): Matrix4x4, CompositeData, bool, int, Material, MaterialPropertyBlock, Mesh, TextureHandle (+4 more)
...
Cohesion: 0.19
Nodes (8): Awaitable, CancellationToken, HashSet, int, ISeedProvider, IWorldActionManager, Type, SceneBootstrap
...
Cohesion: 0.24
Nodes (6): AtmosphereDiagnostics, Awaitable, bool, int, StringBuilder, Texture2D
