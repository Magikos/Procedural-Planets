...
# pp-visual-migration-campaign (discovery stub)

The full skill lives at `.agent-skills/pp-visual-migration-campaign/SKILL.md` at the repo root - read that file
now and follow it. It is the single source of truth; its sub-files, scripts/, and
templates live beside it. Do not edit this stub; edit the source skill.
